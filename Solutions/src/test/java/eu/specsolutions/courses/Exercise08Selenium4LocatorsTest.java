...
public class Exercise08Selenium4LocatorsTest extends ExerciseTestBase {
    ...
    public void TaskA() {
        ...
        WebElement lastNameTextInput = driver.findElement(
                RelativeLocator.with(By.tagName("input")).below(By.cssSelector("label[for=surname]")));
        ...
        WebElement firstNameTextInput = driver.findElement(
                RelativeLocator.with(By.tagName("input")).above(lastNameTextInput));
        ...
        WebElement ageNumberInput = driver.findElement(
                RelativeLocator.with(By.cssSelector("input[type=number]")).near(lastNameTextInput).above(By.cssSelector("label[for=country]")));
