...
import eu.specsolutions.courses.pages.InputValidationExamplesPage;
...
public class Exercise12PageObjects extends ExerciseTestBase {
    ...
    public void TaskB() {
        ...
        //    for you.
        page.goTo();
        Boolean submitResult = page.submitInputForm("Zaphod", "Beeblebroox", 43, "United Kingdom", "Some notes");
        assertTrue(submitResult, "Submission should succeeded");
        InputValidationResponsePage resultPage = new InputValidationResponsePage(driver);
        ...
        //    was provided.
        page.goTo();
        Boolean validationSubmitResult = page.submitInputForm("Zaphod", "Beeblebrox", 43, "United Kingdom", "Some notes");
        assertFalse(validationSubmitResult, "Submission should have failed");
