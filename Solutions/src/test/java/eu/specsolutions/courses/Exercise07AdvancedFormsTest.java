...
public class Exercise07AdvancedFormsTest extends ExerciseTestBase {
    ...
    public void TaskA() {
        ...
        comments.clear();
        comments.sendKeys("Long comments come here!\nAnd a new line");
        ...
        driver.findElement(By.cssSelector("input[name='checkboxes[]'][value='cb1']")).click();
        driver.findElement(By.cssSelector("input[name='checkboxes[]'][value='cb3']")).click();

        // 4. Make sure only the 'radio 1' is selected
        driver.findElement(By.cssSelector("input[name=radioval][value='rd1']")).click();
        ...
        Select multiSelectListBox = new Select(driver.findElement(By.name("multipleselect[]")));
        multiSelectListBox.deselectAll();
        multiSelectListBox.selectByIndex(0);
        multiSelectListBox.selectByValue("ms2");
        multiSelectListBox.selectByVisibleText("Selection Item 3");
        ...
        driver.findElement(By.name("username")).sendKeys("Zaphod");
        driver.findElement(By.name("password")).sendKeys("secret1234!");
