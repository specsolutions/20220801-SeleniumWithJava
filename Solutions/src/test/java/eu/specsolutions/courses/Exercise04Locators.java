...
public class Exercise04Locators extends ExerciseTestBase {
    ...
    public void TaskA() {
        ...
        //driver.findElement(By.id("no-such-id"));

        // 4. Find the second paragraph by CSS class name ('By.className') to make the assertion pass.
        WebElement anotherPara = driver.findElement(By.className("sub"));
        ...
        WebElement paragraphOfTextWithCSS = driver.findElement(By.cssSelector("#para1"));
        ...
        WebElement anotherParaWithCSS = driver.findElement(By.cssSelector(".sub"));
        ...
        String pageSourceDifferently = driver.findElement(By.tagName("html")).getAttribute("outerHTML");
    ...
    public void TaskB() {
        ...
        WebElement paraA = driver.findElement(By.name("pName1"));
        ...
        WebElement jumpToPara0Link = driver.findElement(By.linkText("jump to para 0"));
        ...
        WebElement secondParaWithCSS = driver.findElement(By.cssSelector("p:nth-of-type(2)"));
        ...
        WebElement firstNestedPara = driver.findElement(By.cssSelector(".nestedDiv p"));
        ...
        WebElement firstNestedParaWithXPath = driver.findElement(By.xpath("//div[@class='nestedDiv']/p"));
        ...
        WebElement nestedDiv = driver.findElement(By.className("nestedDiv"));
        WebElement firstNestedParaWithNestedLocator = nestedDiv.findElement(By.tagName("p"));
        ...
        WebElement nestedDivAgain = driver.findElement(By.className("nestedDiv"));
        WebElement secondNestedPara = nestedDivAgain.findElements(By.tagName("p")).get(1);
